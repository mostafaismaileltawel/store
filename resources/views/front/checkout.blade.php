                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[billing][emai]"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="select-items">
                                                        <x-form.profile_selection name="addr[billing][country]"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Email Address</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[shipping][emai]"
                                                            placeholder="Email Address" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="select-items">
                                                        <x-form.profile_selection name="addr[shipping][country]"
                                                            :options='$countries' placeholder="Country" />
                                                    </div>
                                                </div>
                                            </div>
